...
test('six journey fixtures declare route, safety, evidence, and forbidden claims', async () => {
  const fixtures = await loadFixtures();
  assert.deepEqual(fixtures.map((fixture) => fixture.journey).sort(), ['Build', 'Design', 'Discover', 'Learn', 'Release', 'Verify']);

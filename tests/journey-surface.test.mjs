...
const JOURNEYS = ['forgemind-compass', 'forgemind-spark', 'forgemind-evolve', 'forgemind-venture', 'forgemind-council', 'forgemind-ship', 'forgemind-leap', 'forgemind-autopilot'];
...
test('Marketplace exposes the primary journeys while retaining internal modules', async () => {
  ...
  for (const journey of JOURNEYS) {
    ...
    if (journey !== 'forgemind-autopilot') { assert.match(instructions, /zero-input-defaults\.md/i); assert.match(ui, /Zero-Input Default/); }
  }

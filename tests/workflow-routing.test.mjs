...
const JOURNEYS = ['forgemind-start', 'forgemind-compass', 'forgemind-leap', 'forgemind-council', 'forgemind-venture', 'forgemind-spark', 'forgemind-evolve', 'forgemind-ship', 'forgemind-autopilot', 'forgemind-portfolio', 'forgemind-transform', 'forgemind-twin', 'forgemind-evolve-ui', 'forgemind-growth', 'forgemind-xray'];

test('fifteen journeys are the complete primary skill hierarchy', async () => {
  const directories = [];
  ...
  for (const journey of JOURNEYS.filter((name) => !['forgemind-start', 'forgemind-compass', 'forgemind-autopilot', 'forgemind-portfolio', 'forgemind-transform', 'forgemind-twin', 'forgemind-evolve-ui', 'forgemind-growth'].includes(name))) assert.match(compass, new RegExp(`\\$${journey}`));
});

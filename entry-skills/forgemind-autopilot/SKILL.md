...
Run `forgemind autopilot start --goal "<outcome>"`, then `forgemind autopilot run` and `forgemind autopilot status`. Resume an interruption with `forgemind autopilot resume`.

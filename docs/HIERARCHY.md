...
The hierarchy is operational, not an inheritance model: each journey owns its outcome and loads only the internal modules necessary for the task. Safety boundaries override every journey.

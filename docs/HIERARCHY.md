...
ForgeMind exposes exactly three Marketplace entry points. They are intentionally small: the system chooses and applies the required specialist route internally, while the CLI keeps its advanced commands for deliberate automation and debugging.

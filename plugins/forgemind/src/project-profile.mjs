...
function audience(category) { return ({ 'enterprise-operations': 'service operations teams', 'creator-saas': 'independent creators', 'developer-tools': 'software development teams', 'b2b-software': 'business teams' })[category]; }
function job(category) { return ({ 'enterprise-operations': 'resolve operational incidents faster', 'creator-saas': 'produce publishable media faster', 'developer-tools': 'ship and maintain software with less friction', 'b2b-software': 'complete a recurring business workflow with less effort' })[category]; }

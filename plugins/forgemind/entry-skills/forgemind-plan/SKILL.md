...
Start from the strongest available evidence: an innovation portfolio, user signals, repository inspection, and stated constraints. Define one outcome, target user, non-goals, success metric, kill condition, and rollback boundary before decomposing work.
